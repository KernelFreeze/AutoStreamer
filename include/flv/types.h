...
#define swap_sint16(x) ((sint16)((((x)&0x00FF) << 8) | (((x)&0xFF00) >> 8)))

/* swap 32 bits integers */
#define swap_uint32(x)                                                                             \
    ((uint32)((((x)&0x000000FFU) << 24) | (((x)&0x0000FF00U) << 8) | (((x)&0x00FF0000U) >> 8) |    \
              (((x)&0xFF000000U) >> 24)))
...
#define uint24_be_to_uint32(x) ((uint32)(((x).b[0] << 16) | ((x).b[1] << 8) | (x).b[2]))
